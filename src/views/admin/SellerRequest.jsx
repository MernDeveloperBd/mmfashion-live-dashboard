                            ...
                            <table className="w-full text-sm text-left text-[#d0d2d6]">
                                <thead className="text-xs text-[#d0d2d6] uppercase border-b border-slate-700">
                                    <tr>
                                        ...
                                        <th scope="col" className="py-2 px-2">Email</th>
                                        <th scope="col" className="py-2 px-2">Payment Status</th>
                                ...
                                <tbody>
                                    ...
                                    {
                                        [1, 2, 3, 4, 5].map((d, i) => <tr key={i} className='border-b border-slate-700'>
                                            <td scope="col" className="py-2 px-2 font-medium whitespace-normal">{d}</td>
                                             <td scope="col" className="py-2 px-2 font-medium whitespace-normal">
