...
const Sellers = () => {
  ...
  const { sellers, totalSellers } = useSelector(state => state.seller); // fixed
          ...
          <table className="w-full text-sm text-left text-[#d0d2d6]">
            <thead className="text-xs text-[#d0d2d6] uppercase border-b border-slate-700">
              <tr>
                ...
                <th className="py-3 px-2">Shop Name</th>
              ...
              {sellers.map((seller, i) => (
                <tr key={seller?._id || i}>
                  ...
                  <td className="py-1 px-2">
                    <img className='w-[35px] h-[45px] object-cover' src={seller?.image} alt="seller_image" />
                  </td>
                  <td className="py-1 px-2">
                  ...
                  <td className="py-1 px-2">
                    <div className='flex items-center gap-4'>
                      <Link to={`/admin/dashboard/seller/details/${seller?._id}`} className='p-[6px] bg-green-500 rounded hover:shadow-lg hover:shadow-yellow-500/50'><FaEye /></Link>
                    </div>
                  </td>
                </tr>
              ))}
