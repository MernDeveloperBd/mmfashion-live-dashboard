...
const Orders = () => {
    ...
    const [perPage, setPerPage] = useState(10);
     ...
     useEffect(() => {
      ...
      }, [perPage, userInfo,dispatch, currentPage, searchValue]);
                        ...
                        <tbody>
                            {
                                myOrders.map((d, i) => <tr key={i}>
                                    ...
                                    <td scope='row' className='py-3 px-4 font-medium whitespace-nowrap'>TK {d.price}</td>
                                    ...
                                    <td scope='row' className='py-3 px-4 font-medium whitespace-nowrap'>
                                        <Link to={`/seller/order/details/${d._id}`} className='p-[6px] w-[30px] bg-green-500 rounded hover:shadow-lg hover:shadow-green-500/50 flex justify-center items-center'><FaEye /></Link>
                                    </td>
                                </tr>)
                            }
                        </tbody>
