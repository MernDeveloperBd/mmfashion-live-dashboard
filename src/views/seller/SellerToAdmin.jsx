 ...
 useEffect(() => {
  ...
  const send = (e) => {
    ...
    dispatch(send_message_seller_admin({
      ...
      receverId: '', // legacy admin inbox (allowed by controller)
      message: text.trim(),
  ...
  // after DB insert success -> push realtime to admin
  useEffect(() => {
            ...
            <div className='flex justify-between items-center'>
              <div className='flex justify-start items-center gap-3'>
                <div className='relative'>
                  <img className='w-[42px] h-[42px] border-green-500 border-2 max-w-[42px] p-[2px] rounded-full' src={adminImage} alt="admin_image1" />
                    ...
                    return (
                      <div key={i} className='w-full flex justify-end items-center'>
                        <div className='flex justify-start items-start gap-2 md:px-3 py-2 max-w-full lg:max-w-[85%]'>
                          ...
                          <div>
                            <img className='w-[38px] h-[38px] border-2 border-white rounded-full max-w-[38px] p-[3px]' src={userInfo?.image || sellerImage} alt="seller_img" />
                          </div>
                        </div>
                      </div>
                    )
